...
{
    [DbContext(typeof(SqlDotaLeagueContext))]
    [Migration("20210831185448_Added_PlayerShort_Model_")]
    partial class Added_PlayerShort_Model_
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DotaLeague.Domain.Entities.Player", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<DateTime>("TimeOutDateTime")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("DotaLeague.Domain.Entities.Report", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DotaLeague.Domain.Entities.Report", b =>
                {
                    b.HasOne("DotaLeague.Domain.Entities.Player", null)
                        .WithMany("Reports")
